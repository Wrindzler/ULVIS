...
const insertLic = db.prepare(`
  INSERT INTO yazilim_lisanslari (yazilim_adi, lisans_anahtari, baslangic_tarihi, bitis_tarihi, maliyet, durum, koltuk_sayisi)
  VALUES (?, ?, ?, ?, ?, ?, ?)
`);
...
const licenseData = [
  ['Microsoft Office 365', 'MS365-CORP-001', '2025-01-01', fmt(addDays(today, 30)), 45000, 'Aktif', 10],
  ['Adobe Creative Cloud', 'ADOBE-CC-002', '2025-03-01', fmt(addDays(today, 15)), 32000, 'Aktif', 5],
  ['MATLAB R2025a', 'MAT-2025-003', '2025-02-01', fmt(addDays(today, 45)), 28000, 'Aktif', 2],
  ['AutoCAD 2025', 'ACAD-2025-004', '2025-01-15', fmt(addDays(today, 7)), 18000, 'Aktif', 1],
  ['VMware vSphere', 'VMW-ENT-005', '2024-06-01', fmt(addDays(today, 75)), 55000, 'Aktif', 3],
  ['Kaspersky Endpoint', 'KAS-EP-006', '2025-01-01', fmt(addDays(today, 60)), 12000, 'Aktif', 25],
  ['Microsoft Windows Server', 'WIN-SRV-007', '2024-01-01', fmt(addDays(today, 180)), 35000, 'Aktif', 2],
  ['JetBrains All Products', 'JB-ALL-008', '2025-04-01', fmt(addDays(today, 15)), 8500, 'Aktif', 4],
  ['Zoom Business', 'ZOOM-BIZ-009', '2025-02-01', fmt(addDays(today, 90)), 15000, 'Aktif', 15],
  ['SolidWorks 2025', 'SW-2025-010', '2025-03-01', fmt(addDays(today, 30)), 42000, 'Aktif', 1],
];
